...
function Home() { // Acabar la redireccion del click a la pagina correspondiente 
  ...
  return (
    <div className="text-white flex-wrap ">
      <h1 className="flex py-18 justify-center text-6xl">Bienvenido a PokeTu</h1>
      ...
      {user ? (<div className="flex flex-wrap justify-center  px-20 text-white">
        ...
        <div className="p-5">
          ...
          <button className="mt-auto w-full border border-gray-600 bg-gray-700 hover:bg-blue-900  h-10  rounded" onClick={() => navigate('/pokedex')}>GO</button>
        </div>
      </div>
        ...
        <img src="src/images/mejorespacks.webp" className="rounded h-55"/>
          ...
          <button className="mt-auto w-full border border-gray-600 bg-gray-700 hover:bg-blue-900  h-10  rounded" onClick={() => navigate('/packs')}>GO</button>
        </div>
      </div>
      <div className="flex max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <img src="src/images/pokemons.webp" className="rounded h-55"/>
          ...
          <button className="mt-auto w-full border border-gray-600 bg-gray-700 hover:bg-blue-900  h-10  rounded" onClick={() => navigate('/team')}>GO</button>
        </div>
      </div>
      <div className="flex max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div className="flex flex-col p-5">
        <img src="src/images/equipo.jpg" className="rounded h-55"/>
          ...
          <button className="mt-auto w-full border border-gray-600 bg-gray-700 hover:bg-blue-900  h-10  rounded" onClick={() => navigate('/myteam')}>GO</button>
        </div>
      </div>
      <div className="flex max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="flex flex-col p-5">
        <img src="src/images/mejorespacks.webp" className="rounded h-55"/>
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Game  </h5>
          
          <p className="mb-3 font-normal text-gray-700  dark:text-gray-400">Do you wanna test the strong of your team?. Here u can see what level your team can reach</p>
          <button className="mt-auto w-full border border-gray-600 bg-gray-700 hover:bg-blue-900  h-10  rounded" onClick={() => navigate('/game')}>GO</button>
        </div>
      </div>
      </div>
      ) : (
